...
public class Status {
    ...
    static {
        ...
        statuses.put("D", new Status("D", 4,
                "Delivered. The message has been delivered to the addressee (mobile phone confirmation has been received). This status is only available if delivery receipt was activated in the sending."));
        statuses.put("B", new Status("B", 5,
                "Buffered. Message has been sent to operator yet not to addresse. Mobile switched off or out of range. Operator will retry sending until recipient receives sms. This status is only available if delivery receipt was activated in the sending."));
