...
public class Sender {
     ...
     * @param text content
     * @param options aditional options (delivery_receipt, data_coding,
     * schedule). See https://api.lleida.net/dtd/sms/v2/en/#sms
     * @return true or false depending on the result of the HTTP request
     * @throws UnsupportedEncodingException
     * @throws Exception
     */
    public boolean sms(String id, JsonArray dst, String text, JsonObject options)
     ...
     * @param dst recipient(s)
     * @param text content
     * @param options aditional options. Use the 'delivery_receipt' index to
     * configure it. See https://api.lleida.net/dtd/sms/v2/en/#delivery_receipt
     * @return true or false depending on the result of the HTTP request
     * @throws UnsupportedEncodingException
     * @throws Exception
     */
    public boolean registeredSMS(String id, JsonArray dst, String text, JsonObject options)
            throws UnsupportedEncodingException, Exception {
     ...
     * @param dst recipient(s)
     * @param text content
     * @param options aditional options. Use the 'schedule' index to configure
     * it. See https://api.lleida.net/dtd/sms/v2/en/#schedule
     * @return true or false depending on the result of the HTTP request
     * @throws UnsupportedEncodingException
     * @throws Exception
     */
    public boolean scheduledSMS(String id, JsonArray dst, String text, JsonObject options)
            throws UnsupportedEncodingException, Exception {
     ...
     * @param dst recipient(s)
     * @param text content
     * @param options aditional options. See
     * https://api.lleida.net/dtd/sms/v2/en/#sms
     * @return true or false depending on the result of the HTTP request
     * @throws UnsupportedEncodingException
     * @throws Exception
     */
    public boolean mt(String id, JsonArray dst, String text, JsonObject options)
            throws UnsupportedEncodingException, Exception {
    ...
    public Status getStatusSMS(String id) throws UnsupportedEncodingException, IOException {
        ...
        this.debug("json" + this.protect_json(json));
        return this.response_parser_status("mt", id,
                this.do_request(Sender.SERVICE_MSG, URLEncoder.encode(json, "UTF-8")));
    }
    ...
    private String make_json_mt(String id, JsonArray dst, String text, JsonObject options) throws Exception {
        ...
        // perque no peti
        if (options == null) {
            options = JsonObject.EMPTY_JSON_OBJECT;
        }
    ...
    private JsonObject check_options(JsonObject options) {
        ...
        if (options.containsKey("delivery_receipt")) {
            ...
            if (delivery_receipt.containsKey("cert_type")) {
                delivery_receipt_job.add("cert_type",
                        this.check_registered_type(delivery_receipt.getString("cert_type")));
            }
    ...
    private String check_number(String num, String prefix) {
        ...
        if (num.charAt(0) == '+') {
            ...
            /**
             * As long as we haven't found "+", " " or "00" in the number we'll
             * assume they missed the prefix and we'll add it if there is not.
             */
    ...
    private boolean toBool(String value) {
        ...
        return value.equals("1") || value.equals("true") || value.equals("on") || value.equals("yes")
                || value.equals("y");
    }
